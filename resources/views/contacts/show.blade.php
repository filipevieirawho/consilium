    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <!-- Data Overview (Left Col, 2/3 width) -->
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:{{ $contact->email }}"
                                        class="block text-base text-indigo-600 hover:underline">{{ $contact->email }}</a>
                                </div>
                                <div>
                                    <span class="block text-sm font-medium text-gray-500">Telefone</span>
                                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $contact->phone) }}"
                                        target="_blank"
                                        class="block text-base text-indigo-600 hover:underline">{{ $contact->phone }}</a>
                                </div>
                                <div>
                ...
                <!-- Assignment and Status Forms (Right Col, 1/3 width) -->
