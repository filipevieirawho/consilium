        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 print-grid">
                ...
                <div class="md:col-span-1 ipm-block">
                    @if($resultado)
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-2 p-6 text-center h-full flex flex-col"
                ...
                <div class="md:col-span-1 radar-block">
                    @if($resultado)
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-100 p-6 h-full flex flex-col">
            ...
            <div class="mb-4 no-print flex items-center justify-between">
                ...
                <span class="text-xs font-medium text-gray-400 mr-2">Respondido {{ $respondidas }} de {{ $totalQuestoes }}</span>
            </div>
