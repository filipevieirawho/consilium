...
<x-diagnosticos.layout :progressPct="100" progressLabel="Resultado">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <!-- IPM Card -->
        <div class="sm:rounded-lg border-2 p-8 text-center flex flex-col h-full"
             style="background-color: {{ $cfg['bg'] }}; border-color: {{ $cfg['border'] }};">
            <h3 class="text-xs font-bold uppercase tracking-widest w-full" style="color: {{ $cfg['text'] }}; opacity: 0.8;">Previsibilidade de Margem</h3>
        ...
        <!-- Radar Chart Card -->
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-100 p-8 flex flex-col h-full">
            <h3 class="text-xs font-bold uppercase tracking-widest text-gray-400 w-full">Desempenho por Dimensão</h3>
            <div class="flex-1 flex items-center justify-center" style="max-height: 250px; aspect-ratio: 1;">
