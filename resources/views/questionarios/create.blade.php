                        ...
                        <div class="flex-1">
                            ...
                            <div x-show="activeTab === 'info'" class="space-y-5 animate-fade-in">
                                <div class="bg-white shadow-sm sm:rounded-lg border border-gray-100 p-8">
                                    ...
                                    <div class="space-y-5">
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 pb-10 border-b border-dashed border-gray-100 mb-10">
                                            <div>
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="titulo" value="{{ old('titulo') }}"
                                                   ...
                                                   class="block w-full text-sm font-bold text-gray-800 rounded-lg border-gray-300 focus:border-[#D0AE6D] focus:ring-[#D0AE6D] shadow-sm transition-all px-4 py-2.5">
                            ...
                            <div x-show="activeTab === 'questions'" class="space-y-5 animate-fade-in" x-cloak>
                                <div class="bg-white shadow-sm sm:rounded-lg border border-gray-100 p-8">
                                    ...
                                    <div id="questoes-empty" class="text-center py-20 text-gray-400 rounded-2xl mt-4">
